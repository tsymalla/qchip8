...
namespace compiler
{
	class Token final
	{
	  public:
		...
		explicit Token(TokenKind kind, std::string_view content, size_t start, size_t end,
		               const ValueType& value = std::monostate());

		static Token MakeToken(TokenKind kind, std::string_view content, size_t start, size_t end,
		                       const ValueType& value = std::monostate())
		{
	  ...
	  private:
		...
		constexpr static const char* TOKEN_NAMES[] = {"NUMBER",
		                                              "ID",
		                                              "OPEN_BRACKET",
		                                              "CLOSE_BRACKET",
		                                              "OPEN_CURLY_BRACKET",
	...
	class Lexer final
	{
		constexpr static const char* KEYWORDS[] = {"program", "var",    "const", "if",    "else",
		                                           "void",    "number", "bool",  "while", "return"};
