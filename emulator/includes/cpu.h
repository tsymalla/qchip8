	...
	class CPU : public QObject
	{
	  ...
	  private:
		...
		inline const static std::map<int, int> KEY_MAP = {
			{Qt::Key_1, 0x1}, {Qt::Key_2, 0x2}, {Qt::Key_3, 0x3}, {Qt::Key_4, 0xC}, {Qt::Key_Q, 0x4}, {Qt::Key_W, 0x5},
			{Qt::Key_E, 0x6}, {Qt::Key_R, 0xD}, {Qt::Key_A, 0x7}, {Qt::Key_S, 0x8}, {Qt::Key_D, 0x9}, {Qt::Key_F, 0xE},
